...
14. **Prepare competition submission**: Write up results, document all hardware job IDs, compile evidence of 4-bit hardware success on Rigetti Ankaa-3, IonQ Forte-1, and IBM Pittsburgh, and 6-bit simulator success. Submit to competition.
